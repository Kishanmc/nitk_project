      ...
      <div className="w-full max-w-md">
        <div className="bg-dark-800 rounded-2xl shadow-2xl border border-dark-600 p-8">
          <div className="text-center mb-8">
            <div className="w-16 h-16 bg-patient/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-dark-700 border border-dark-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-patient focus:border-transparent transition"
            ...
            <button
              type="submit"
              className="w-full py-3 bg-patient hover:bg-patient-dark text-white font-semibold rounded-lg transition-colors duration-200"
            >
              Sign In as Patient
            </button>
          </form>
